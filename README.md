...
--- | --- | :---: | ---
`date` | `String` | - | Date of reading.
`time` | `String` | - | Time of reading.
`glucose` | `String` | - | Glucose result.
`serial` | `String` | - | Meter Serial.
`unit` | `String` | - | Unit of measure for glucose values.
`userFlag` | `String` | - | Alpha value for user flag.
`mealComment` | `String` | - | Numerical value representing user comment.
...
See [LICENSE](https://github.com/matheussampaio/medical-device-server/blob/master/LICENSE) file.
